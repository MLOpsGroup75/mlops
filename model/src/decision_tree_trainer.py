...
class DecisionTreeTrainer(BaseTrainer):
    ...
    def __init__(self, model_type: str = "decision_tree", 
        ...
        self.model_name = f"decision_tree" if model_type == "decision_tree" else model_type
        self.pipeline = None
        self.best_params = {}
    ...
    def train(self, X_train: pd.DataFrame, y_train: pd.Series,
              ...
              use_scaling: bool = False, **kwargs) -> Dict[str, Any]:
        """
    ...
    def tune_hyperparameters(self, X_train: pd.DataFrame, y_train: pd.Series,
                           cv: int = 5, search_type: str = "random", 
                           n_iter: int = 50, use_scaling: bool = False,
                           **kwargs) -> Dict[str, Any]:
        """
    ...
    def train_with_hyperparameter_tuning(self, X_train: pd.DataFrame, y_train: pd.Series,
        ...
        if self.pipeline is not None:
            ...
            # Add feature importance metrics
            for feature_name, importance in tuning_results['feature_importance'].items():
                mlflow_metrics[f'feature_importance_{feature_name}'] = importance
