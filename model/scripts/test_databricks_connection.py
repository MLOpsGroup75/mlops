            ...
            for alt_path in alternative_paths:
                try:
                    ...
                    if experiment is None:
                        ...
                        logger.info(
                            f"✅ Created experiment with alternative path: {alt_path}"
                        )
                        return True
                    else:
                        logger.info(
                            f"✅ Found experiment with alternative path: {alt_path}"
                        )
                        return True
...
def main():
    ...
    if not success:
        ...
        logger.info(
            "3. Try creating a folder '/Shared/mlops' in your Databricks workspace"
        )
