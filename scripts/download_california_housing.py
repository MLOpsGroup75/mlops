...
def download_california_housing_dataset():
    ...
    print(f"Target: {housing.target_names[0] if hasattr(housing, 'target_names') and housing.target_names else 'MedHouseVal'}")
    print(f"\nFirst few rows:")
...
if __name__ == "__main__":
    try:
        ...
        print(f"📊 Dataset contains {metadata['n_samples']} samples with {metadata['n_features']} features")
