...
class TestSettingsEnvironmentVariables:
    ...
    def test_api_settings_from_env(self):
        ...
        env_vars = {"API_HOST": "127.0.0.1", "API_PORT": "9000", "API_DEBUG": "true"}
    ...
    def test_rate_limiting_from_env(self):
        ...
        env_vars = {"RATE_LIMIT_REQUESTS": "10", "RATE_LIMIT_WINDOW": "30"}
    ...
    def test_service_settings_from_env(self):
        ...
        env_vars = {"SERVICE_NAME": "custom-mlops-service", "SERVICE_VERSION": "2.1.0"}
...
class TestSettingsEdgeCases:
    ...
    def test_very_large_numbers(self):
        ...
        env_vars = {"RATE_LIMIT_REQUESTS": "999999", "MAX_BODY_LOG_SIZE": "999999999"}
    ...
    def test_negative_numbers(self):
        ...
        env_vars = {"API_PORT": "-1", "RATE_LIMIT_REQUESTS": "-5"}
